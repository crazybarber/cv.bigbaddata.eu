  ...
  <div class="resume">
    ...
    <div class="content">
        ...
        <div
          ...
          <div class="section-content">
            <a
                ...
                :key="index"
                :class="{ link: cert.url !== undefined}"
                :href="cert.url">
                <span class="section-content__text">{{ cert.name }}</span>
                <span class="section-content__text--light">{{ cert.issuer }}</span>
            </a>
          </div>
        </div>
      ...
      <div class="content__right">
        <div class="section">
          <div class="section-headline">
            <i class="section-headline__icon material-icons">person</i>{{ lang.about }}
          </div>

          <div class="section-content section-content__text">
            {{ person.about }}
          </div>
        </div>
