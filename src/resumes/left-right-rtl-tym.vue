...
<div class="resume" id="resume1">
  ...
  <div class="left half">
    ...
    <div class="contact">
      ...
      <table>
        ...
        <tr v-if="person.contact.linkedin">
          <td><i class="fa fa-linkedin" aria-hidden="true"></i></td>
          <td><a :href="contactLinks.linkedin">{{contactLinks.linkedin}}</a></td>
        </tr>
      </table>
    </div>
  </div>
  <div class="right half">
    ...
    <div class="certifications">
      <h3>{{ lang.certifications }}</h3>
      <div class="certifications-block" v-for="cert in person.certifications" :key="cert.name">
        <span class="cert-name"> <a :href="cert.url">{{cert.name}}</a></span>
        <br>
...
#resume1 {
  ...
  .experience .experience-block span.job-description {
    text-align: justify;
  }
  ...
  .certifications .certifications-block span {
    color:#616161;
  }

  .certifications .certifications-block span.cert-name {
    padding-top:10px;
    color:#424242;
  }

  .certifications .certifications-block span.cert-issuer {
    font-size: 10px;
  }
